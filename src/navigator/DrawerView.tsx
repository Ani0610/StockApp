...
const DrawerView = ({ navigation, state }: any) => {
  ...
  const jobworkMenu = [
    ...
    { name: 'Work By Team', label: "Job by team", isSubmenu: false, iconName: 'people', iconType: 'material' },
    { name: 'Team', label: "Work By Team", isSubmenu: false, iconName: 'run-circle', iconType: 'material' },

  ]

  const MenuCopomponent = ({ items, type }: any) => (
    <>
      ...
      <ScrollView style={styles.scrollContainer}>
        {(() => {
          switch (user?.userType) {
            case "admin":
              return (
                <MenuCopomponent items={adminMenu} type={user.userType} />
              );
            case "godown":
              return (
                <MenuCopomponent items={godownMenu} type={user.userType} />
              );
            case "jobwork":
              return (
                <MenuCopomponent items={jobworkMenu} type={user.userType} />
              );
            case "carrier":
              return (
                <>
