                            ...
                            {designs?.map((item: any, i: any) => (
                                <View key={i} style={[GlobalStyle.card, GlobalStyle.shadowProp, {
                                    ...
                                    <View style={GlobalStyle.middleSide}>
                                        <Text style={GlobalStyle.textcolor} numberOfLines={1} ellipsizeMode="tail">{item.mesurement}</Text>
                                        <Text style={GlobalStyle.textcolor} numberOfLines={1} ellipsizeMode="tail">{item.price}₹(1 Meter)</Text>
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 10, marginVertical: Platform.OS === "ios" ? 30 : 0, zIndex: 0 }}>
                        <View style={{
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <Text style={{ color: 'black', fontSize: 20 }}>Add Design Details</Text>
                            ...
                            <View style={{
                                ...
                                <View style={{ marginTop: 10 }}>
                                    ...
                                    {errors.mesurement && touched.mesurement &&
                                        <Text style={[GlobalStyle.errorMsg, { marginHorizontal: 10 }]}>{errors.mesurement}</Text>
                                    }
                                </View>
