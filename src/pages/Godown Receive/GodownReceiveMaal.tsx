import { View, Text, SafeAreaView, StatusBar, ScrollView, Pressable, Alert, TouchableOpacity } from 'react-native'
...
const GodownReceiveMaal = ({ navigation }: any) => {
  ...
  const receiveMaal: any = [
    { jobNo: 123, challanNo: 123, designNo: '#123', partyName: 'Anu creation', piece: 500 }
  ]
  const handleFilter = () => {
    console.log('fiter')
  }
